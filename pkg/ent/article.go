...
// ReadArticlesOrErr returns the ReadArticles value or an error if the edge
// was not loaded in eager-loading.
func (e ArticleEdges) ReadArticlesOrErr() ([]*ReadArticle, error) {
	if e.loadedTypes[1] {
		return e.ReadArticles, nil
	}
	return nil, &NotLoadedError{edge: "read_articles"}
}
...
func (a *Article) QueryReadArticles() *ReadArticleQuery {
	return NewArticleClient(a.config).QueryReadArticles(a)
}
