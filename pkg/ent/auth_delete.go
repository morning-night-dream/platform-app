...
func (ad *AuthDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, AuthMutation](ctx, ad.sqlExec, ad.mutation, ad.hooks)
}
...
func (ad *AuthDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(auth.Table, sqlgraph.NewFieldSpec(auth.FieldID, field.TypeUUID))
