...
// ByLastLoggedInAt orders the results by the last_logged_in_at field.
func ByLastLoggedInAt(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldLastLoggedInAt, opts...).ToFunc()
}
